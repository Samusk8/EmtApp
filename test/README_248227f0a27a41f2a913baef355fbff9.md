# EMT Palma - Aplicación de Consulta de Líneas y Paradas

## Descripción

Aplicación PyQt6 para consultar información en tiempo real del transporte público EMT de Palma de Mallorca. La aplicación incluye:
